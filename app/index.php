...
$routes = [
    [ "name" => "Tabulation"      , "route" => "/mrms-balatan"             ],
    ...
    [ "name" => "Top5 (Female)"          , "route" => "results/Top5 (Female)"         ],
    [ "name" => "Top5(Male)"          , "route" => "results/Top5(Male)"         ]
];
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Mister and Miss Balatan</title>
</head>
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" > Mister and Miss Balatan</h1>
                <p class="fst-italic" >Mister and Miss Balatan </p>
            </div>
